...
import { EXCEEDANCE_FILTER_KEYS } from '../../constants/filters.js'
...
export default function ExceedancesPage() {
  ...
  const query = useListQuery(listExceedances, EXCEEDANCE_FILTER_KEYS)
  ...
  return (
    <>
      ...
      <ExceedanceFilters
        ...
        onReset={() => {
          setSelected([])
          query.setFilters(EXCEEDANCE_FILTER_KEYS)
        }}
      />
