...
import { QUERY_FILTER_KEYS, PERIOD_OPTIONS, EXCEEDED_OPTIONS, EXCEEDANCE_STATUS_OPTIONS, DATA_SOURCE_OPTIONS } from '../../../constants/filters.js'
...
export default function QueryFilters({ value, loading, onSubmit, onReset }) {
  ...
  const { draft, update, submit, reset, onKeyDownSubmit } = useFilterDraft(
    value, QUERY_FILTER_KEYS, { onSubmit, onReset }
  )
